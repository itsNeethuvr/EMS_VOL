...
SECRET_KEY = 'django-insecure-ffy$n!27$$@)lwvt+ccd^e&t_b)^3jd#34e06&i!b!d+c3mz)2'
DEBUG = True
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',  # Add if you're using CORS
    'vol_app',
    'django_extensions',
]
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Example for a frontend app
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'vol_app/static')]
